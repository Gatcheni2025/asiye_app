...
window.ASIYE_DRIVER_LOGIN = {
    ...
    init() {
        ...
        this.bindEvents();
        // Do not eagerly initialize browser reCAPTCHA. Hosted web will
        // create it lazily only if the Firebase JS phone flow is actually used.
        // The installed Flutter app must use native Firebase phone auth.
...
(() => {
    ...
    const isInstalledAssetApp = () =>
        ...
        /flutter_assets|\/assets\/driver-v2\//i.test(location.href);
